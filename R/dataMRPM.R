## Version: 
## Last-Updated: Jun 13 2020 (09:13) 
...
### Code:
options(width=70)
setwd("~/research/Methods/PredictionModelsMonograph/medical-prediction-models/data/")
